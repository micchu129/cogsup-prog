...
for i in range(time_steps(speed, 330)): #adjusted distance to 300 and slowly scaled back up
    #i started perceiving less diruption of causality about 320, and was unable to perceive a difference at 330 (20 pixels distance at 'contact')
